...
";
        ...
        private static void SaveParquet(ExportDataForm edit, Traces waveforms)
        {
            ...
            ParquetSimple.SaveCols(edit.Filename, waveforms.Names, columns, waveforms.SamplesPerSeconds, waveforms.SampleOffsets, isTimeStamp);
        }
        ...
        private static void LoadWaveformsParquetInner(SehensControl scope, ImportDataParquetForm edit)
        {
            try
            {
                ...
                {
                    var columns = ParquetSimple.LoadCols(path);
